...
export default function SignIn() {
  ...
  const handleComingSoon = (method: string) => {
    setComingSoonMsg(`${method} sign-in is coming soon! Please use email for now.`);
      ...
      >
        ...
        <div style={{ textAlign: 'center', marginBottom: 'clamp(20px, 6vw, 32px)' }}>
          ...
          <p className="text-body-subtext" style={{ color: '#6b7280' }}>
            Sign in to access your skin condition history
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <div>
            {/* Password label + Forgot Password on same row */}
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 6 }}>
              <label htmlFor="input-password" style={{ fontSize: '0.875rem', fontWeight: 500, color: '#374151' }}>
                Password
              </label>
              <button
                type="button"
